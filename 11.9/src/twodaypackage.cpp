...
#include<string>
using namespace std;
TwoDayPackage::TwoDayPackage(const string &send,const string &adder,const string &add,const string &cs,const string &sta,const string co,double stor,double trans,double two)
