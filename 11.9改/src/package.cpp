...
Package::Package(const string &send,const string &adder,const string &add,const string &cs,const string &sta,const string &co,double stor,double c)
:sender(send),addressee(adder),address(add),city(cs),state(sta),code(co),storage(stor),cost(c)
{
}
